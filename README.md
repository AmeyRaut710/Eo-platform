...
If you are running this project on a new system for the first time, please follow these steps:
...
3. **Run the Application**: Double-click the `run_eo_platform.bat` script. This script will automatically:
   - Start the required Docker containers (MinIO and PostgreSQL)
